...
Начинающий backend-разработчик на Python. Завершил расширенную программу **«Python-разработчик»** в Яндекс Практикуме.

В процессе обучения работал с Python, Django, REST API, Flask и FastAPI, изучал асинхронное программирование, алгоритмы и структуры данных, работу с удалённым сервером и парсинг данных.

Интересуюсь backend-разработкой и хочу развиваться в создании серверных приложений, API и сервисов на Python.

Готов начать карьеру в команде разработки на позиции Junior Backend Developer.
...
| Инструменты | Git, GitHub, Linux, командная строка, виртуальные окружения, работа с удалённым сервером |
| Дополнительно | парсинг данных, тестирование, командная разработка, опыт тимлида |
